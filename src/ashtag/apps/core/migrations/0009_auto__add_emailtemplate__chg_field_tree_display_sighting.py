...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_emailtemplate', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=16, primary_key=True)),
        ...
        # Changing field 'Tree.display_sighting'
        db.alter_column(u'core_tree', 'display_sighting_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['core.Sighting'], unique=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tree.display_sighting'
        db.alter_column(u'core_tree', 'display_sighting_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Sighting']))
    ...
    models = {
        ...
        u'core.emailtemplate': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '16', 'primary_key': 'True'}),
        ...
        u'core.sighting': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'omh35y'", 'max_length': '6', 'primary_key': 'True'}),
        ...
        u'core.tree': {
            ...
            'flagged': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.CharField', [], {'default': "'00shd7'", 'max_length': '6', 'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
