...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailTemplate.default_to'
        db.alter_column(u'core_emailtemplate', 'default_to', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'EmailTemplate.default_to'
        db.alter_column(u'core_emailtemplate', 'default_to', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'core.sighting': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'hbbho8'", 'max_length': '6', 'primary_key': 'True'}),
        ...
        u'core.tree': {
            ...
            'flagged': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.CharField', [], {'default': "'1ay1vn'", 'max_length': '6', 'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
