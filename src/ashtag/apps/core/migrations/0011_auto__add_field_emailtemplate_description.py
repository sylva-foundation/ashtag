...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_emailtemplate', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_emailtemplate', 'description')
    ...
    models = {
        ...
        u'core.sighting': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'lwgodn'", 'max_length': '6', 'primary_key': 'True'}),
        ...
        u'core.tree': {
            ...
            'flagged': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.CharField', [], {'default': "'sjmima'", 'max_length': '6', 'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
