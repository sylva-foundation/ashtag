...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tree.tag_checked_by'
        db.add_column(u'core_tree', 'tag_checked_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tree.tag_checked_by'
        db.delete_column(u'core_tree', 'tag_checked_by_id')
    ...
    models = {
        ...
        u'core.sighting': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'brtc5o'", 'max_length': '6', 'primary_key': 'True'}),
        ...
        u'core.tree': {
            ...
            'flagged': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.CharField', [], {'default': "'akusv7'", 'max_length': '6', 'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
