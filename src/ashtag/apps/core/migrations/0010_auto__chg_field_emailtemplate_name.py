...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_emailtemplate', 'name', self.gf('django.db.models.fields.CharField')(max_length=32, primary_key=True))

    def backwards(self, orm):

        # Changing field 'EmailTemplate.name'
        db.alter_column(u'core_emailtemplate', 'name', self.gf('django.db.models.fields.CharField')(max_length=16, primary_key=True))
    ...
    models = {
        ...
        u'core.sighting': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'k64tzv'", 'max_length': '6', 'primary_key': 'True'}),
        ...
        u'core.tree': {
            ...
            'flagged': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.CharField', [], {'default': "'h0z6ko'", 'max_length': '6', 'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
